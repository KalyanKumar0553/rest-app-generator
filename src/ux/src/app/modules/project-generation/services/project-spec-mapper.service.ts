...
export class ProjectSpecMapperService {
  ...
  mapProjectToGeneratorSpec(project: any): any {
    ...
    const spec: any = {
      ...
      enableOpenapi: isNodeProject ? false : Boolean(project?.preferences?.enableOpenAPI),
      enableActuator: isNodeProject ? false : Boolean(project?.preferences?.enableActuator),
      enableLombok: isNodeProject ? false : Boolean(
      ...
      packages: isNodeProject ? 'technical' : (trimmed(project?.preferences?.packages) || 'technical'),
    ...
    if (!isNodeProject && Boolean(project?.preferences?.enableActuator)) {
