...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, MatButtonModule, RbacModuleTabComponent, AuthModuleTabComponent, StateMachineModuleTabComponent, SubscriptionModuleTabComponent, SwaggerModuleTabComponent, CdnModuleTabComponent],
