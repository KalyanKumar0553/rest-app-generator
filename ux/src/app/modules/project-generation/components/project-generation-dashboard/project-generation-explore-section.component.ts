...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, MatButtonModule, MatIconModule, MatTableModule, MatTooltipModule, HelpPopoverComponent, HelpPopoverTriggerDirective, ProjectViewComponent, ProjectGenerationExploreMigratePanelComponent],
