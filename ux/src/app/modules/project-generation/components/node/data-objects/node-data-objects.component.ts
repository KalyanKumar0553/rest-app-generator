...
@Component({
  selector: 'app-node-data-objects',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './node-data-objects.component.html',
  styleUrls: ['./node-data-objects.component.css']
})
export class NodeDataObjectsComponent implements OnInit, OnChanges {
