...
import { BasicSettingsComponent } from '../../rest-config/basic-settings/basic-settings.component';
import { EndpointConfigComponent } from '../../rest-config/endpoint-config/endpoint-config.component';
import { RequestResponseConfigComponent } from '../../rest-config/request-response-config/request-response-config.component';
import { DocumentationConfigComponent } from '../../rest-config/documentation-config/documentation-config.component';
import { RestConfigOverflowSheetComponent } from '../../rest-config/rest-config-overflow-sheet/rest-config-overflow-sheet.component';
...
@Component({
  ...
  templateUrl: './node-rest-config.component.html',
  styleUrls: ['./node-rest-config.component.css'],
  animations: [
    trigger('tabContent', [
      transition('* <=> *', [
...
export class NodeRestConfigComponent implements OnChanges, AfterViewInit, OnDestroy {
