...
public class AdminPlanFeatureController {
	...
	public ResponseEntity<ApiResponseDto<List<PlanFeatureResponse>>> replaceFeatures(
			@PathVariable Long planId,
			@RequestBody List<@Valid PlanFeatureUpsertRequest> requests) {
	...
	@PreAuthorize("hasAuthority('subscription.feature.manage')")
	public ResponseEntity<ApiResponseDto<PlanFeatureResponse>> upsertFeature(
			@PathVariable Long planId,
			@PathVariable Long featureId,
			@Valid @RequestBody PlanFeatureUpsertRequest request) {
