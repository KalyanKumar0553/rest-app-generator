 ...
 *
 * Set your API key in the OPENAI_API_KEY constant below before running.
 */
public class AiOpenAiConnectionTest {
	...
	public static void main(String[] args) throws Exception {
		if ("REPLACE_WITH_YOUR_KEY".equals(OPENAI_API_KEY)) {
			System.err.println("ERROR: Set your OpenAI API key in the OPENAI_API_KEY constant before running.");
			System.exit(1);
		}
