...
public class ProjectContributorPermissionUpdateDTO {
	...
	public ProjectContributorPermissionUpdateDTO() {
	}
	...
	public boolean equals(final Object o) {
		...
		if (!(o instanceof ProjectContributorPermissionUpdateDTO)) return false;
		final ProjectContributorPermissionUpdateDTO other = (ProjectContributorPermissionUpdateDTO) o;
	...
	protected boolean canEqual(final Object other) {
		return other instanceof ProjectContributorPermissionUpdateDTO;
	}
	...
	public String toString() {
		return "ProjectContributorPermissionUpdateDTO(canEditDraft=" + this.isCanEditDraft() + ", canGenerate=" + this.isCanGenerate() + ", canManageCollaboration=" + this.isCanManageCollaboration() + ")";
	}
}
