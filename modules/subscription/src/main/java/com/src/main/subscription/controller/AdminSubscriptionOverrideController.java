...
public class AdminSubscriptionOverrideController {
	...
	public ResponseEntity<ApiResponseDto<SubscriptionOverrideResponse>> create(@PathVariable Long tenantId, @Valid @RequestBody SubscriptionOverrideRequest request) {
	...
	@PreAuthorize("hasAuthority(\'subscription.override.manage\')")
	public ResponseEntity<ApiResponseDto<SubscriptionOverrideResponse>> update(@PathVariable Long tenantId, @PathVariable Long overrideId, @Valid @RequestBody SubscriptionOverrideRequest request) {
	...
	public AdminSubscriptionOverrideController(final SubscriptionOverrideService subscriptionOverrideService) {
		this.subscriptionOverrideService = subscriptionOverrideService;
	}
}
