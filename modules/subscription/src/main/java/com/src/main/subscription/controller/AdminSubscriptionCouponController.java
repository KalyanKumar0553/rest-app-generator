...
public class AdminSubscriptionCouponController {
	...
	@PutMapping("/{id}")
	@PreAuthorize("hasAuthority(\'subscription.coupon.manage\')")
	public ResponseEntity<ApiResponseDto<SubscriptionCouponResponse>> updateCoupon(@PathVariable Long id, @Valid @RequestBody SubscriptionCouponRequest request) {
	...
	@GetMapping
	@PreAuthorize("hasAuthority(\'subscription.coupon.read\')")
	public ResponseEntity<ApiResponseDto<List<SubscriptionCouponResponse>>> getCoupons(@RequestParam(name = "activeOnly", required = false) Boolean activeOnly) {
	...
	public AdminSubscriptionCouponController(final SubscriptionCouponService subscriptionCouponService) {
		this.subscriptionCouponService = subscriptionCouponService;
	}
}
