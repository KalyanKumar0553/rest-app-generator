...
- UX builds the entire YAML on demand in [`ux/src/app/modules/project-generation/components/project-generation-dashboard/project-generation-dashboard.component.ts`](/Users/ky/Workspace/rest-app-generator/ux/src/app/modules/project-generation/components/project-generation-dashboard/project-generation-dashboard.component.ts) and [`ux/src/app/modules/project-generation/components/node-project-generation-dashboard/node-project-generation-dashboard.component.ts`](/Users/ky/Workspace/rest-app-generator/ux/src/app/modules/project-generation/components/node-project-generation-dashboard/node-project-generation-dashboard.component.ts).
- Mapping is done in [`ux/src/app/modules/project-generation/services/project-spec-mapper.service.ts`](/Users/ky/Workspace/rest-app-generator/ux/src/app/modules/project-generation/services/project-spec-mapper.service.ts).
